...
1. Number of `<span class="code-inline__content">dead-letter-exchange</span>` letters in RabbitMQ
2. Number of message `<span class="code-inline__content">in flight</span>` in RabbitMQ
...
25. Number of `<span class="code-inline__content">HTTP 200</span>` for shop API
26. Number of `<span class="code-inline__content">HTTP 200</span>` for CRM API
27. Number of `<span class="code-inline__content">HTTP 200</span>` for MES API
28. Number of `<span class="code-inline__content">HTTP 500</span>` for shop API
29. Number of `<span class="code-inline__content">HTTP 500</span>` for CRM API
30. Number of `<span class="code-inline__content">HTTP 500</span>` for MES API
31. Number of `<span class="code-inline__content">HTTP 500</span>` for shop API
